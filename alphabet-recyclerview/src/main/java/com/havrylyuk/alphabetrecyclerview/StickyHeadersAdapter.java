...
public interface StickyHeadersAdapter<HeaderViewHolder extends RecyclerView.ViewHolder> {
    ...
    /**
     * Create a header {@link android.support.v7.widget.RecyclerView.ViewHolder ViewHolder}
     * witch encapsulate the header view
     ...
     * @param headerViewHolder the header holder {@link android.support.v7.widget.RecyclerView.ViewHolder ViewHolder}
     * @param position the header position
     */
    void onBindHeaderViewHolder(HeaderViewHolder headerViewHolder, int position);
